...
<style scoped>
  .sign {
    ...
    padding: 0 16rpx;
    height: 206rpx;
    background: linear-gradient(360deg, rgba(240, 245, 248, 1) 0%, rgba(255, 255, 255, 1) 100%);
  ...
  .item__award {
    ...
    box-shadow: 0 0 24rpx 0 rgba(176, 197, 218, .52);
    border: 1rpx solid rgba(231, 236, 239, 1);
    border-radius: 10rpx;
  }
  ...
  .item__award::after {
    ...
    border-bottom: 15rpx solid rgba(254, 255, 254, 1);
  }
...
<template>
  <div class="sign box flex relative">
    <div
    ...
    >
      ...
      <div
        class="item__award box absolute flex flex-jc-center flex-ai-start"
        v-if="item.award"
      >
        <span class="award__span ft-bold ft-24 line-fill">+{{item.award}}</span>
        <img
          class="award__icon"
      ...
      <div
        class="item__intro absolute ft-24 line-fill ft-semi-bold"
        v-if="item.intro"
      >{{item.intro}}</div>
    </div>
  </div>
