...
function request(params) {var
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      ...
      method: method,
      success: function success(response) {var
...
/***/ 185:
/*!*********************************************************************!*\
  !*** /Users/jax/workspace/weight-control-uniapp/static/js/utils.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.formatTime = formatTime;function formatTime(targetTime) {
  var date = new Date(targetTime);
  var YY = date.getFullYear();
  var MM = date.getMonth() + 1 < 10 ? '0' + (date.getMonth() + 1) : date.getMonth() + 1;
  var DD = date.getDate() < 10 ? '0' + date.getDate() : date.getDate();
  return "".concat(YY, "\u5E74").concat(MM, "\u6708").concat(DD, "\u65E5");
}
...
/***/ 210:
/*!*******************************************************************************!*\
  !*** /Users/jax/workspace/weight-control-uniapp/static/apis/groupSchedule.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 51:
/*!************************************************************************!*\
  !*** /Users/jax/workspace/weight-control-uniapp/static/apis/upload.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getUploadOSSParams = getUploadOSSParams;exports.uploadImage2ServerByUniApp = uploadImage2ServerByUniApp;exports.uploadImage = uploadImage;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@vue/babel-preset-app/node_modules/@babel/runtime/regenerator */ 12));var _base = _interopRequireDefault(__webpack_require__(/*! @/static/js/base */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
...
function uploadImage2ServerByUniApp(file, _ref)





{var serverUrl = _ref.serverUrl,fileKey = _ref.fileKey,policyBase64 = _ref.policyBase64,accessid = _ref.accessid,signature = _ref.signature;
...
uploadImage(_x) {return _uploadImage.apply(this, arguments);}function _uploadImage() {_uploadImage = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(file) {var ossParams;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;_context.next = 3;return (

              getUploadOSSParams(file));case 3:ossParams = _context.sent;_context.next = 6;return (
              uploadImage2ServerByUniApp(file, ossParams.data.result));case 6:return _context.abrupt("return", "".concat(
            ossParams.data.result.serverUrl).concat(ossParams.data.result.fileKey));case 9:_context.prev = 9;_context.t0 = _context["catch"](0);

            console.err('error ===>', _context.t0);case 12:case "end":return _context.stop();}}}, _callee, null, [[0, 9]]);}));return _uploadImage.apply(this, arguments);}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-alipay/dist/index.js */ 1)["default"]))
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.userFetchTasks = userFetchTasks;exports.userCheckinDiet = userCheckinDiet;exports.userCheckinSport = userCheckinSport;var _base = _interopRequireDefault(__webpack_require__(/*! @/static/js/base */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/report/index": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/user/index": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/micha/index": { "usingComponents": {}, "usingAutoImportComponents": { "talk-micha": "/components/talk-micha/talk-micha", "talk-user": "/components/talk-user/talk-user", "micha-footer": "/components/micha-footer/micha-footer" } }, "pages/record/diet/index": { "usingComponents": {}, "usingAutoImportComponents": { "base-page": "/components/base-page/base-page", "card-header": "/components/card-header/card-header", "card-upload": "/components/card-upload/card-upload", "card-score": "/components/card-score/card-score", "card-textarea": "/components/card-textarea/card-textarea" } }, "pages/record/guide/index": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/record/sport/index": { "usingComponents": {}, "usingAutoImportComponents": { "base-page": "/components/base-page/base-page", "card-header": "/components/card-header/card-header", "card-sport": "/components/card-sport/card-sport", "card-textarea": "/components/card-textarea/card-textarea" } }, "pages/index/index": { "usingComponents": {}, "usingAutoImportComponents": { "base-page": "/components/base-page/base-page", "punch-sign": "/components/punch-sign/punch-sign", "punch-card": "/components/punch-card/punch-card", "class-list": "/components/class-list/class-list" } }, "pages/class/index": { "usingComponents": {}, "usingAutoImportComponents": { "class-list": "/components/class-list/class-list" } }, "pages/bind/index": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/auth/index": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/guide/index": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/record/index": {} }, "globalStyle": { "defaultTitle": "micha", "titleBarColor": "#007AFF", "backgroundColor": "#FFFFFF" } };exports.default = _default;

/***/ }),

/***/ 77:
/*!******************************************************************************!*\
  !*** /Users/jax/workspace/weight-control-uniapp/static/apis/bonusProduct.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.userFetchRecomProducts = userFetchRecomProducts;exports.userFetchAllProduct = userFetchAllProduct;exports.userExchangeProduct = userExchangeProduct;var _base = _interopRequireDefault(__webpack_require__(/*! @/static/js/base */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__0BDA50C" };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.userFetchCheckCode = userFetchCheckCode;exports.userBindAccount = userBindAccount;var _base = _interopRequireDefault(__webpack_require__(/*! @/static/js/base */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
