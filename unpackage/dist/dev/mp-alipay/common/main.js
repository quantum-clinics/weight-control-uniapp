...
/* 0 */
/*!**********************************************************!*\
  !*** /Users/jax/workspace/weight-control-uniapp/main.js ***!
  \**********************************************************/
...
/* 9 */
/*!**********************************************************!*\
  !*** /Users/jax/workspace/weight-control-uniapp/App.vue ***!
  \**********************************************************/
/*! no static exports found */
...
component.options.__file = "Users/jax/workspace/weight-control-uniapp/App.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),
/* 10 */
/*!***********************************************************************************!*\
  !*** /Users/jax/workspace/weight-control-uniapp/App.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...

{
  ...
  onLaunch: function onLaunch() {var _this = this;
    this.login = new Promise( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(resolve, reject) {var _yield$userGetProvide, provider, _yield$getUserSetting, authSetting, userInfoAuth, _yield$userLoginByUni, code, platformInfo, miChaServerRes;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;_context.next = 3;return (


                  (0, _login.userGetProviderInfo)());case 3:_yield$userGetProvide = _context.sent;provider = _yield$userGetProvide.provider;
                _this.globalData.provider = provider[0];
                (0, _base.setRequestHeader)("QTC-Platform", provider[0]);
                (0, _login.setProvider)(provider[0]);
                console.log("1, 获取当前平台信息", provider[0]);

                // 获取授权设置
                _context.next = 11;return (0, _login.getUserSettingByUniApp)();case 11:_yield$getUserSetting = _context.sent;authSetting = _yield$getUserSetting.authSetting;
                console.log("2, 获取当前平台授权设置", authSetting);

                // 当前用户是否授权
                userInfoAuth = (0, _login.userInfoAuthSetting)(authSetting, "userInfo");

                console.log("3, 当前用户是否授权", userInfoAuth);

                // 当前用户未授权
                if (userInfoAuth) {_context.next = 20;break;}
                _this.loginResolve = resolve;

                uni.redirectTo({
                  url: "/pages/auth/index" });return _context.abrupt("return");case 20:_context.next = 22;return (
                  ...
                  (0, _login.userLoginByUniApp)());case 22:_yield$userLoginByUni = _context.sent;code = _yield$userLoginByUni.code;
                console.log("4, 获取当前授权code", code);

                // 获取用户平台数据
                _context.next = 27;return (0, _login.getUserInfoByUniApp)();case 27:platformInfo = _context.sent;
                _this.globalData.userInfo = platformInfo.userInfo;
                console.log("5, 获取当前平台用户信息", platformInfo);

                // 获取用户米茶数据
                _context.next = 32;return (0, _login.userLoginByMiChaServer)(
                code,
                platformInfo.userInfo);case 32:miChaServerRes = _context.sent;
                ...
                uni.redirectTo({
                  url: "/pages/bind/index" });return _context.abrupt("return");case 39:
                ...
                reject(_context.t0);case 47:case "end":return _context.stop();}}}, _callee, null, [[0, 43]]);}));return function (_x, _x2) {return _ref.apply(this, arguments);};}());
...
/* 18 */
/*!*******************************************************************************************!*\
  !*** /Users/jax/workspace/weight-control-uniapp/App.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
