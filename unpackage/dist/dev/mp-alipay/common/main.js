...
/* 0 */
/*!************************************************!*\
  !*** /Users/jax/workspace/QTC/uni-app/main.js ***!
  \************************************************/
...
/* 9 */
/*!************************************************!*\
  !*** /Users/jax/workspace/QTC/uni-app/App.vue ***!
  \************************************************/
/*! no static exports found */
...
component.options.__file = "Users/jax/workspace/QTC/uni-app/App.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),
/* 10 */
/*!*************************************************************************!*\
  !*** /Users/jax/workspace/QTC/uni-app/App.vue?vue&type=script&lang=js& ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...

{
  ...
  onLaunch: function onLaunch() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$userGetProvide, provider, uniAppLoginRes, _yield$getUserSetting, authSetting, _yield$getUserInfoByU, userInfo, miChaServerRes;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;_context.next = 3;return (


                (0, _authLogin.userGetProviderInfo)());case 3:_yield$userGetProvide = _context.sent;provider = _yield$userGetProvide.provider;
              console.log(provider);

              _this.globalData.provider = provider[0];

              // 获取当前用户登陆code
              _context.next = 9;return (0, _authLogin.userLoginByUniApp)(provider[0]);case 9:uniAppLoginRes = _context.sent;_context.next = 12;return (


                (0, _authLogin.getUserSettingByUniApp)());case 12:_yield$getUserSetting = _context.sent;authSetting = _yield$getUserSetting.authSetting;if (


              authSetting['scope.userInfo']) {_context.next = 17;break;}
              uni.redirectTo({
                url: '/pages/auth/index' });return _context.abrupt("return");case 17:_context.next = 19;return (





                (0, _authLogin.getUserInfoByUniApp)());case 19:_yield$getUserInfoByU = _context.sent;userInfo = _yield$getUserInfoByU.userInfo;_context.next = 23;return (


                (0, _authLogin.userLoginByMiChaServer)(uniAppLoginRes.code, userInfo));case 23:miChaServerRes = _context.sent;

              _this.globalData.openid = miChaServerRes.data.data.result.openid;

              // 判断当前用户是否需要绑定手机号码
              if (miChaServerRes.data.data.result.needBind) {
                uni.redirectTo({
                  url: '/pages/bind/index' });

              }_context.next = 31;break;case 28:_context.prev = 28;_context.t0 = _context["catch"](0);


              console.error(_context.t0);case 31:case "end":return _context.stop();}}}, _callee, null, [[0, 28]]);}))();
...
/* 17 */
/*!*********************************************************************************!*\
  !*** /Users/jax/workspace/QTC/uni-app/App.vue?vue&type=style&index=0&lang=css& ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
