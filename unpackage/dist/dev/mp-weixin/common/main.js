...
var _authLogin = __webpack_require__(/*! @/static/js/authLogin */ 15);
...

{
  ...
  onLaunch: function onLaunch() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$userGetProvide, provider, uniAppLoginRes, _yield$getUserSetting, authSetting, _yield$getUserInfoByU, userInfo, miChaServerRes;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;_context.next = 3;return (
              ...
              _this.globalData.provider = provider[0];_context.next = 8;return (

                (0, _authLogin.userLoginByUniApp)(provider[0]));case 8:uniAppLoginRes = _context.sent;_context.next = 11;return (

                (0, _authLogin.getUserSettingByUniApp)());case 11:_yield$getUserSetting = _context.sent;authSetting = _yield$getUserSetting.authSetting;if (


              authSetting["scope.userInfo"]) {_context.next = 16;break;}
              uni.redirectTo({
                url: "/pages/auth/index" });return _context.abrupt("return");case 16:_context.next = 18;return (




                (0, _authLogin.getUserInfoByUniApp)());case 18:_yield$getUserInfoByU = _context.sent;userInfo = _yield$getUserInfoByU.userInfo;_context.next = 22;return (

                (0, _authLogin.userLoginByMiChaServer)(
                uniAppLoginRes.code,
                userInfo));case 22:miChaServerRes = _context.sent;


              console.log(miChaServerRes);

              _this.globalData.openid = miChaServerRes.result.profile.openid;
              ...
              }_context.next = 32;break;case 29:_context.prev = 29;_context.t0 = _context["catch"](0);

              console.error(_context.t0);case 32:case "end":return _context.stop();}}}, _callee, null, [[0, 29]]);}))();

  },
  methods: {
    auth: function auth() {} } };exports.default = _default;
